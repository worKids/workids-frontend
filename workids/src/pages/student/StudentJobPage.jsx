...
export default function StudentJobPage() {
  ...
  const navbar = navbarMenu.map((menu, index) => (
    <div
      ...
      className={`my-3 border hoverable border-dark border-3 text-center p-3 rounded-pill sideNav ${
        ...
        <div style={divStyle}>
          ...
          <div className="d-flex justify-content-center ">
            <div className="mb-5" style={{ position: "absolute", bottom: 0 }}>
              ...
              <div className="bibi hoverable m-auto" onClick={navigateToMain}></div>
            </div>
          </div>
        </div>
