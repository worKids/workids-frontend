...
export default function StudentRanking() {
  ...
  return (
    ...
    <div className="container d-flex justify-content-end px-1" style={{ fontSize: "15px"}}>(단위:{userData.moneyName})</div>    
