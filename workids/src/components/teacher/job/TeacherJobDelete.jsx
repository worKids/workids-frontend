  ...
  const handleDeleteJob = () => {
    ...
    return(
      ...
      >
        ...
        <Modal.Body>
          <div className="info-label fs-5 text-center">정말로 삭제하시겠습니까?</div>
        </Modal.Body>
        <Modal.Footer>
          <div onClick={handleDeleteJob} className="info-label fs-5 modal-button">
            Yes
          </div>
          <div onClick={handleClose} className="info-label fs-5 modal-button">
            No
          </div>
        </Modal.Footer>
      </Modal>
